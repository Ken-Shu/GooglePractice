package com.ken_shu.myapplication
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        h_view = findViewById<EditText>(R.id.h_view)
        w_view = findViewById<EditText>(R.id.w_view)
        result_view = findViewById<EditText>(R.id.result_bmi)
